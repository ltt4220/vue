            ...
            <div class="zm-component-blog-detail">
              <div class="zm-component-blog-upcont">
                <div class="zm-component-blog-title">
                  <a class="zm-component-blog-title-a" target="_blank" zm-href="item.Detail" zm-data-type-hovercolor="settingData.hoverColor.value" zm-data-old-color="settingData.Familyfont.value.color" zm-style="{font-family:settingData.Familyfont.value.fontFamily,font-style:settingData.Familyfont.value.fontStyle,font-weight:settingData.Familyfont.value.fontWeight,font-size:settingData.Familyfont.value.fontSize}">
                    {{item.title}}
                  </a>
                </div>
