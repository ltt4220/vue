          ...
          <div class="zm-component-blog-box" :data-sortid="item.fId" :data-show="true" :data-time="fCreateTime.date" zm-data-title="item.fTitle">
            ...
            <div class="zm-component-blog-detail">
              <div class="zm-component-blog-upcont">
                ...
                <div class="zm-component-blog-word}" zm-style="{height:settingData.lineHeightNum.num,font-family:settingData.blogContFont.value.fontFamily,font-size:settingData.blogContFont.value.fontSize,color:settingData.blogContFont.value.color,font-weight:settingData.blogContFont.value.fontWeight,font-style:settingData.blogContFont.value.fontStyle,margin-top:settingData.ContmarginTop.value,text-indent:settingData.ContTextIndent.value,line-height:settingData.ContLineHeight.value,margin-bottom:settingData.ContmarginBottom.value,text-align:settingData.ContcontrolRowAlign.value}">
                  {{item.cont}}
                </div>
