            ...
            <div class="zm-component-blog-detail">
              <div class="zm-component-blog-upcont">
                ...
                <div class="zm-component-blog-viewMore">
                  <a class="zm-component-details" target="_blank" zm-href="item.Detail" zm-data-type-hovercolor="settingData.DishoverColor.value" zm-data-old-color="settingData.blogScale.value" zm-style="{color:settingData.blogScale.value}">
