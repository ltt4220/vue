<template>
  <div :id="prop.id" class="zm-component-main">
    <div class="zm-component-blog-content wordsBlog" data-type="words" >
      <span v-for="(item,i) in items" :key="i">
          <div class="zm-component-blog-box" :data-sortid="item.fId" :data-show="true" :data-time="item.fCreateTime" zm-data-title="item.fTitle">
            ...
            "Content-Type":"application/json;charset=utf-8"
              ...
              if (0 == result) {
                ...
                data.forEach(element => {
                  var  date =new Date(data.fCreateTime).toLocaleString().replace(/:d{1,2}$/, ' ');
                  _this.items.push(data) ;
                  _this.items.fCreateTime = data.fCreateTime;
                });
