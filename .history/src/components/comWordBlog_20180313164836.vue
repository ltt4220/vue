<template>
  <div :id="prop.id" class="zm-component-main" :style="{position:unitData.position;width:unitData.width,height:unitData.height,left:unitData.x,top:unitData.y,z-index:unitData.zIndex}">
