<template>
  <div :id="prop.id" class="zm-component-main" :style="{position:unitData.positionwidth:unitData.width,height:unitData.height,left:unitData.x,top:unitData.y,z-index:unitData.zIndex}">
