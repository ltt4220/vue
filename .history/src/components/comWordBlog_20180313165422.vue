  ...
  <div :id="prop.id" class="zm-component-main" :style="{position:unitData.position, width:unitData.width,height:unitData.height,left:unitData.x,top:unitData.y,zIndex:unitData.zIndex}">
    <div class="zm-component-blog-content wordsBlog" data-type="words" :data-num="num">
      <span v-for="(item,i) in list" :key="i">
          <div class="zm-component-blog-box" :data-sortid="item.fId" :data-show="true" :data-time="item.fCreateTime" :data-title="item.fTitle" :style="{backgroundolor:settingData.BoxBackgroundColor.value,margin-bottom:settingData.BoxMarginBottom.value,padding-left:settingData.paddingLeftRight.value,padding-right:settingData.paddingLeftRight.value}">
