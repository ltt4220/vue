          ...
          <div class="zm-component-blog-box" :data-sortid="item.fId" :data-show="true" :data-time="item.fCreateTime" :data-title="item.fTitle" :style="{backgroundColor:settingData.BoxBackgroundColor.value,marginBottom:settingData.BoxMarginBottom.value,paddingLeft:settingData.paddingLeftRight.value,paddingRight:settingData.paddingLeftRight.value}">
            ...
            <div class="zm-component-blog-detail">
              <div class="zm-component-blog-upcont" :style="{textAlign:settingData.controlRowAlign.value,marginTop:settingData.TitmarginTop.value,marginBottom:settingData.TitmarginBottom.value,fontFamily:settingData.Familyfont.value.fontFamily,fontStyle:settingData.Familyfont.value.fontStyle,fontWeight:settingData.Familyfont.value.fontWeight,fontSize:settingData.Familyfont.value.fontSize}">
                ...
                <div class="zm-component-blog-date" style="{font-family:settingData.blogTimeFont.value.fontFamily,font-size:settingData.blogTimeFont.value.fontSize,color:settingData.blogTimeFont.value.color,font-weight:settingData.blogTimeFont.value.fontWeight,font-style:settingData.blogTimeFont.value.fontStyle,text-align:settingData.blogTimeAlign.value,margin-top:settingData.blogTimeTop.value,margin-bottom:settingData.blogTimeBottom.value,display:settingData.blogShow.num}">{{item.fCreateTime}}
                </div>
