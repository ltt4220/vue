...
export default {
  ...
  methods:{
      ...
      addLeave:function(i){
            ...
            _this.isOnlay=-1;
             console.log(TargeAttr.y,111111111111111)
             console.log(TargeAttr.height,22222222222) 
            document.onmousemove= function(event){
                ...
                console.log(TargeAttr.y,33333333333)        
                console.log(TargeAttr.height,444444444444444)        
                if (PageX > x){
                    _this.isSelect = false;
                }else{
                    if( PageY > y+20 || PageY < TargeAttr.y){
                        _this.isSelect = false;
                    }
                }
            };
