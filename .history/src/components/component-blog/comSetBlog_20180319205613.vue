...
export default {
  ...
  methods:{
      ...
      addLeave:function(i){
            ...
            if(event.target.className.indexOf("onlay")>-1){
                TargeAttr = event.target.getBoundingClientRect();
                console.log(event.target.className.indexOf("onlay")+"yyyyyyy")
            }else{ return;}
            ...
            document.onmousemove= function(event){
                ...
                console.log(event.target.className.indexOf("onlay"))
