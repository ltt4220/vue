<template>
    <div class="zm-dialog-pageBox mCustomScrollbar" theme="minimal" @mousemove="pageSetMove()">
        ...
        <div class="zm-dialog-carousel-pageSetBox" v-show="isSelect" :style="{top:top}" @mousemove="addMove()">
            <div>重命名</div>
            <div>移除</div>
        </div>
    </div>
...
export default {
  ...
  methods:{
      ...
      addMove:function(){
            ...
            let x = TargeAttr.x + TargeAttr.width;
            let y = TargeAttr.y + TargeAttr.height;
            _this.TargeAttrW = TargeAttr.width;
            _this.TargeAttrH = TargeAttr.height;
            _this.TargeAttrX = TargeAttr.width;
            _this.TargeAttrY = TargeAttr.width;
      },
