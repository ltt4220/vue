<template>
    <div class="zm-dialog-pageBox mCustomScrollbar" theme="minimal" @mousemove.passive="pageSetMove()">
...
export default {
  ...
  methods:{
      ...
      addMove:function(){
            ...
            _this.TargeAttrW = TargeAttr.width + TargeAttr.x;
            _this.TargeAttrH = TargeAttr.height + TargeAttr.y;
            _this.TargeAttrX = TargeAttr.x;
      ...
      pageSetMove:function(){
            let _this = this,
                ...
                console.log(_this)            if(PageX > W || PageX < X){
