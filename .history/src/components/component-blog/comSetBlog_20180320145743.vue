...
export default {
  ...
  methods:{
      ...
      addSetting:function(index){
            let _this = this;
            let num_this.num = index;
            _this.iconShezhi2 = true;
            _this.top = index*41 +"px";
            _this.isOnlayClick= index;
            for(let i = 0; i < _this.list.length; i++){
                _this.list[num].iconShezhi2 = true;
                _this.list[num].isIconDuigou1 = false;
                _this.list[num].isIconEyeOn = true;
                _this.list[num].isIconCha = false;
                _this.list[num].isEyeOff = false;
                _this.list[num].hasError = true;
                _this.list[num].isIconEyeOff = true;
                if(i==index){
                    if(_this.isSelect){
